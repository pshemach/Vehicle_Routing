...
def solve_vrp_for_day(full_matrix, nodes_to_visit, day, demand_dict, penalty_list=None, use_distance=True, max_distance=None, max_visits=None):
    """
    ...
    # Use passed parameters if provided, otherwise fall back to config values
    ...
    # Step 1: Create data model using provided values
