...
This project implements a vehicle routing solution for a distribution center with configurable number of vehicles.
...
- **Route Summary**: `output/summaries/day_1_summary.txt`
- **Route Details**: `output/csv/day_1_routes.csv`
- **Route Visualizations**: `output/maps/day_1_vehicle_Y_route.html`
...
- `PENALTY_WEIGHT`: Penalty weight for not visiting a node
